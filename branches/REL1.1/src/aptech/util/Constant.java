...
public interface Constant {
    ...
    final String ERROR_STRING = "Unexpexted error has been occured";
    final String EMAIL_INVALID = "Invalid Email";
    ...
    final short PERMISSION_ADMIN=0;
    final short PERMISSION_STAFF=1;
