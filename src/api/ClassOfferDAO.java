...
public class ClassOfferDAO extends BaseHibernateDAO {
    ...
    public List<ClassOffer> getClassTeachByStaffid(int staffId) {
        try {
            String queryString = "SELECT DISTINCT co FROM SubjectAssignment sa"
                    + " , ClassOffer co"
                    + " Where co.classOfferId = sa.classOfferId"
                    + " and sa.staffId=?";
