...
public class StudentCourseRegistrationDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory
			.getLog(StudentCourseRegistrationDAO.class);
	// property constants
	...
	public StudentCourseRegistration findById(java.lang.Integer id) {
		...
		try {
			StudentCourseRegistration instance = (StudentCourseRegistration) getSession()
					.get("api.StudentCourseRegistration", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public StudentCourseRegistration merge(
		...
		try {
			StudentCourseRegistration result = (StudentCourseRegistration) getSession()
